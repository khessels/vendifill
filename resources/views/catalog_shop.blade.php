		...
		<div id="app">
			...
			<header id="top-bar" class="top-bar top-bar--s1" data-nav-fixed="true" data-nav-anchor="false">
				...
				<div class="top-bar__line-menu    compensate-for-scrollbar">
					...
					<a class="top-bar__cart-btn" href="#">
										...
										<div class="goods-filter__inner">
											<form action="#">
												...
												<div class="widget widget--categories">
													...
													<ul class="list">
														<li class="list__item">
															<a class="list__item__link" href="#">Combo Machine</a>
															<i class="list__item__arrow js-toggle-submenu"></i>

															<ul class="list__submenu">
																<li class="list__item">
																	<a class="list__item__link active" href="#">Vending Machine</a>
																</li>

																<li class="list__item">
																	<a class="list__item__link" href="#">Ingredients</a>
																</li>

																<li class="list__item">
																	<a class="list__item__link" href="#">Parts for Machine</a>
																</li>
															</ul>
														</li>

														<li class="list__item">
															<a class="list__item__link" href="#">Coffe Machine</a>
															<i class="list__item__arrow js-toggle-submenu"></i>

															<ul class="list__submenu">
																<li class="list__item">
																	<a class="list__item__link" href="#">Vending Machine</a>
																</li>
														...
														<li class="list__item">
															<a class="list__item__link" href="#">Snack Machine</a>
															<i class="list__item__arrow js-toggle-submenu"></i>
														...
														<li class="list__item">
															<a class="list__item__link" href="#">Healthy Snacks</a>
															<i class="list__item__arrow js-toggle-submenu"></i>
														...
														<li class="list__item">
															<a class="list__item__link" href="#">Eco Vending</a>
															<i class="list__item__arrow js-toggle-submenu"></i>
														...
														<li class="list__item">
															...
															<ul class="list__submenu">
																...
																<li class="list__item">
																	<a class="list__item__link" href="#">Parts for Machine</a></li>
															</ul>
														</li>
													</ul>
												</div>
												...
												<div class="widget widget--tags">
													...
													<div class="tags-list">
														<ul class="tags-list__list">
															...
															<li class="tags-list__item"><a class="tags-list__link active" href="#">Ingredients</a></li>
