													...
													<div class="__item __item--preview __item--shadow">
														<div class="__body">
															<div class="__content">
																...
																<h4 class="__title"><a href="#">Corparate Problem in Vending Business</a></h4>
													...
													<div class="__item __item--preview __item--shadow" style="background-image: url(img/posts_img/2.jpg);">
														<div class="__body  d-sm-flex align-items-sm-end">
															<div class="__content">
																...
																<h4 class="__title"><a class="text-white" href="#">Vending Solutions</a></h4>
															</div>
														</div>
															...
															<div class="col-12 col-lg">
																<div class="post-meta">
																	<div class="row justify-content-between align-items-center">
																		...
																		<div class="col-auto">
																			<a class="post-meta__item __reply" href="#"><i class="fontello-reply"></i></a>
																		</div>
																	</div>
																</div>
															</div>
