...
<html class="no-js" lang="en">
	...
	<body class="page-elements-tables">
		<div id="app">
			<!-- start header -->
								...
								<ul>
									...
									<li class="has-submenu">
										...
										<ul class="submenu">
											...
											<li><a class="active" href="/elements-info_tables">Tables</a></li>
					...
					<div class="container">
						<div class="row">
							<div class="col-11 col-sm-12">
								...
								<h1 class="hero__title">Tables</h1>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-12 col-lg-6">
								...
								<div class="info-table info-table--s2">
									<table>
										<thead>
											<tr>
												<td>Name</td>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-12 col-lg-6">
								...
								<div class="info-table info-table--s4">
									<table>
										<thead>
											<tr>
												<td>Name</td>
