...
<html class="no-js" lang="en">
	...
	<body class="page-elements-accordions">
		<div id="app">
			<!-- start header -->
							...
							<nav id="top-bar__navigation" class="top-bar__navigation" role="navigation">
								<ul>
									...
									<li class="has-submenu">
										...
										<ul class="submenu">
											<li><a class="active" href="/element/accordions">Accordion</a></li>
					...
					<div class="container">
						<div class="row">
							<div class="col-11 col-sm-12">
								...
								<h1 class="hero__title">Accordion & Toggles</h1>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-12 col-md-6">
								...
								<div class="content-container">
									<!-- start accordion -->
									<div class="accordion-container" data-type="toggle">
										<!-- start item -->
										<div class="accordion-item">
											<div class="accordion-toggler">
												<h4 class="accordion-title">What is the best Vending Machine?</h4>
