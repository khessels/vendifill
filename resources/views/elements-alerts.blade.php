...
<html class="no-js" lang="en">
	...
	<body class="page-elements-alerts">
		<div id="app">
			<!-- start header -->
								...
								<ul>
									...
									<li class="has-submenu">
										...
										<ul class="submenu">
											...
											<li><a class="active" href="/element/alerts">Alerts</a></li>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-12 col-md-6">
								<div class="alert alert--s1 alert--success alert--dismissible" role="alert">
									<div class="d-table">
										<div class="d-table-cell align-baseline">
											<i class="alert__ico fontello-ok"></i>
										</div>

										<div class="d-table-cell align-baseline">
											<strong>Well done!</strong> You successfully read <a href="javascript:void(0)">this important alert message</a>
										</div>
									</div>

									<button type="button" class="alert__close" title="close me" aria-label="Close">&times;</button>
								</div>

								<div class="alert alert--s1 alert--info alert--dismissible" role="alert">
									<div class="d-table">
										<div class="d-table-cell align-baseline">
											<i class="alert__ico fontello-help"></i>
										</div>

										<div class="d-table-cell align-baseline">
											<strong>Heads up!</strong> This <a href="javascript:void(0)">alert needs your attention</a>, but it's not super important
										</div>
									</div>
								...
								<div class="alert alert--s1 alert--warning alert--dismissible" role="alert">
									<div class="d-table">
										<div class="d-table-cell align-baseline">
											<i class="alert__ico fontello-warning"></i>
										</div>

										<div class="d-table-cell align-baseline">
											<strong>Warning!</strong> Better check yourself, you're <a href="javascript:void(0)">not looking too good</a>
										</div>
									</div>
								...
								<div class="alert alert--s1 alert--danger alert--dismissible" role="alert">
									<div class="d-table">
										<div class="d-table-cell align-baseline">
											<i class="alert__ico fontello-cancel"></i>
										</div>

										<div class="d-table-cell align-baseline">
											<strong>Oh snap!</strong> <a href="javascript:void(0)">Change a few things up</a> and try submitting again
										</div>
									</div>
							...
							<div class="col-12 col-md-6">
								<div class="alert alert--s1 alert--success" role="alert">
									<div class="d-table">
										<div class="d-table-cell align-baseline">
											<i class="alert__ico fontello-ok"></i>
										</div>
								...
								<div class="alert alert--s1 alert--info" role="alert">
									<div class="d-table">
										<div class="d-table-cell align-baseline">
											<i class="alert__ico fontello-help"></i>
										</div>
								...
								<div class="alert alert--s1 alert--warning" role="alert">
									<div class="d-table">
										<div class="d-table-cell align-baseline">
											<i class="alert__ico fontello-warning"></i>
										</div>
								...
								<div class="alert alert--s1 alert--danger" role="alert">
									<div class="d-table">
										<div class="d-table-cell align-baseline">
											<i class="alert__ico fontello-cancel"></i>
										</div>
				...
				<section class="section section--no-pt">
					<div class="container">
						<div class="row">
							...
							<div class="col-12 col-md-6">
								<div class="alert alert--s2 alert--success alert--dismissible" role="alert">
									<div class="d-table">
										<div class="d-table-cell align-baseline">
											<i class="alert__ico fontello-ok"></i>
										</div>
								...
								<div class="alert alert--s2 alert--info alert--dismissible" role="alert">
									<div class="d-table">
										<div class="d-table-cell align-baseline">
											<i class="alert__ico fontello-help"></i>
										</div>
								...
								<div class="alert alert--s2 alert--warning alert--dismissible" role="alert">
									<div class="d-table">
										<div class="d-table-cell align-baseline">
											<i class="alert__ico fontello-warning"></i>
										</div>
								...
								<div class="alert alert--s2 alert--danger alert--dismissible" role="alert">
									<div class="d-table">
										<div class="d-table-cell align-baseline">
											<i class="alert__ico fontello-cancel"></i>
										</div>
							...
							<div class="col-12 col-md-6">
								<div class="alert alert--s2 alert--success" role="alert">
									<div class="d-table">
										<div class="d-table-cell align-baseline">
											<i class="alert__ico fontello-ok"></i>
										</div>
								...
								<div class="alert alert--s2 alert--info" role="alert">
									<div class="d-table">
										<div class="d-table-cell align-baseline">
											<i class="alert__ico fontello-help"></i>
										</div>
								...
								<div class="alert alert--s2 alert--warning" role="alert">
									<div class="d-table">
										<div class="d-table-cell align-baseline">
											<i class="alert__ico fontello-warning"></i>
										</div>
								...
								<div class="alert alert--s2 alert--danger" role="alert">
									<div class="d-table">
										<div class="d-table-cell align-baseline">
											<i class="alert__ico fontello-cancel"></i>
										</div>
