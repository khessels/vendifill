    ...
    @c(['editable'=>true,  'key' => 'hero', 'page' => $page, 'default' => '
        <div id="start-screen" class="start-screen start-screen--style-1">
            <div
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-8 col-sm-8 col-lg-7">
                                <div class="__title text-white">Vending Technology <span>in&nbsp;new Business Era</span></div>
                ...
                <div class="start-screen__slide start-screen__slide--2 align-items-center text-center">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-10 col-lg-8 col-xl-10">
                                <div class="__title text-white">Vending Products <span>in all Offices and Hubs</span></div>
                ...
                <div class="start-screen__slide start-screen__slide--3 align-items-center">
                    <div class="__bg" style="background-image: url(img/start-screen_img/3/1.jpg);background-position: center left 55%;"></div>

                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-md-10 col-lg-8 col-xl-7">
                                <div class="__title">Vending Products in Offices and Hubs</div>
            ...
            <div id="start-screen__slider-nav" class="start-screen__slider-nav start-screen__slider-nav--ver">
            ...
            <div class="start-screen__panel">
                ...
                <div class="video-block">
                    <a href="https://www.youtube.com/embed/1zG1iq9LZ2U" class="btn_play btn_play--white" data-fancybox="video">
                        <span class="d-table">
...
@section('content')
    @c(['editable'=>true,  'key' => 'content', 'page' => $page, 'default' => '
        ...
        <!-- start section -->
        <section class="section section--bg-img jarallax" data-speed="0.3" data-img-position="50% 50%" style="background-image: url(img/bg_8.jpg);background-color: #26282b;">
            <div class="container">
                <div class="row">
                    <div class="col-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="spacer py-5 py-md-8"></div>

                    </div>

                    <div class="col-12 col-md-6">
                        <div class="content-container">
                            <blockquote class="blockquot" style="font-size:inherit;line-height:1.6;">
                                <p>
                                    <strong>Zebra tilapia ocean perch ocean sunfish bichir. Monkfish eel soapfish sabertooth fish whiptail gulper long-finned char hussar.</strong> Flagfin Atlantic saury, stonecat beachsalmon, silver dollar South American Lungfish. Reef triggerfish dogteeth tetra barreleye
                                </p>
                            </blockquote>
                        </div>
                    </div>
        ...
        <!-- start section -->
        <section class="section section--no-pb" style="background-image: url(img/bg_9.jpg);background-repeat: no-repeat;">
            <div class="container">
                <div class="row align-items-md-end justify-content-md-between">
                    ...
                    <div class="col-12 col-md-auto">
                        <div id="slick-dots--container-3" class="mt-10 text-right"></div>
                    </div>
                </div>

                <div class="spacer py-3 py-md-6"></div>
            </div>

            <!-- start services -->
            <div class="services services--slider">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                        <div class="__item  text-center">
                                            ...
                                            <h4 class="__title">Guarntee 100%</h4>
                                        </div>
                                    </div>
                                    <!-- end item -->
                                    ...
                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                        <div class="__item  text-center">
                                            ...
                                            <h4 class="__title">Repair and Service</h4>
                                        </div>
                                    </div>
                                    <!-- end item -->
                                    ...
                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                        <div class="__item  text-center">
                                            ...
                                            <h4 class="__title">Support 24/7</h4>
                                        </div>
                                    </div>
                                    <!-- end item -->
                                    ...
                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                        <div class="__item  text-center">
                                            ...
                                            <h4 class="__title">Quick Delivery</h4>
                                        </div>
                                    </div>
                                    <!-- end item -->
                                    ...
                                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                        <div class="__item  text-center">
                                            ...
                                            <h4 class="__title">Eco Vending</h4>
                                        </div>
                                    </div>
                                    <!-- end item -->
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-7 col-lg-5">
                        ...
                        <div class="section-heading section-heading--left">
                            <h5 class="__subtitle">Gallery</h5>

                            <h2 class="__title">Gallery of <span>Our Products</span></h2>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <!-- start steps -->
                        <div class="steps">
                            <div class="__inner" style="min-width: 800px">
                                <div class="row">
                                    <!-- start item -->
                                    <div class="col">
                                        <div class="__item">
                                            ...
                                            <div class="__line">
                                                <span class="__point"></span>
                                            </div>

                                            <div class="__title h4">Delivery Machine</div>
                                        </div>
                                    </div>
                                    <!-- end item -->
                                    ...
                                    <div class="col">
                                        <div class="__item">
                                            ...
                                            <div class="__title h4">Prepare Installation</div>
                                        </div>
                                    </div>
                                    <!-- end item -->
                                    ...
                                    <div class="col">
                                        <div class="__item">
                                            ...
                                            <div class="__title h4">Analitic Location</div>
                                        </div>
                                    </div>
                                    <!-- end item -->
                                    ...
                                    <div class="col">
                                        <div class="__item">
                                            ...
                                            <div class="__title h4">Machine Settings</div>
                                        </div>
                                    </div>
                                    <!-- end item -->
                                    ...
                                    <div class="col">
                                        <div class="__item">
                                            ...
                                            <div class="__title h4">Prepare Documents</div>
                                        </div>
                                    </div>
                                    <!-- end item -->
                                    ...
                                    <div class="col">
                                        <div class="__item">
                                            ...
                                            <div class="__line">
                                                <span class="__point"></span>
                                                <span class="__point __point--last"><i class="fontello-ok"></i></span>
                                            </div>

                                            <div class="__title h4">Close Project</div>
                                        </div>
                                    </div>
                                    <!-- end item -->
                                </div>
        ...
        <!-- start section -->
        <section class="section section--no-pb section--bg-img jarallax" data-speed="0.3" data-img-position="50% 50%" style="background-image: url(img/bg_5.jpg);background-color: #f95a3f;">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="section-heading section-heading--white section-heading--center">
                            <h5 class="__subtitle">Rent of our products</h5>

                            <h2 class="__title">Rental Pricing Plan</h2>
            ...
            <!-- start goods -->
            <div class="goods-rent goods-rent--slider">
                <div class="slider-special-layout">
                    <div class="slider-special-layout__inner">
                        <div class="slider-special-layout__container">
                    ...
                    <div class="slider-special-layout__nav">
                        <div class="slider-special-layout__container">

                            <div class="row align-items-sm-center justify-content-sm-between">
                                <div class="col-12 col-sm-auto">
                                    <div id="slick-dots--container-4"></div>
                                </div>
            ...
            <div class="shape">
                <svg xmlns="http://www.w3.org/2000/svg" width="1920" height="280" viewBox="0 0 1920 400" preserveAspectRatio="none" style="min-height: 180px">
        ...
        <section class="section section--no-pt section--no-pb">
            <!-- start promo banner -->
            <div class="promo-banner promo-banner--s2">
        ...
        <section class="section section--no-pb section--blog" style="background-image: url(img/bg_11.jpg);background-repeat: no-repeat;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4 col-lg-12">
                                <div class="section-heading section-heading--left">
                                    <h5 class="__subtitle">Blog</h5>

                                    <h2 class="__title">Blog & News<br>on Vending Industry</h2>
                                </div>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="spacer py-3 d-lg-none"></div>
                        ...
                        <div class="posts">
                            <div class="__inner">
                                <div class="row">
                                    <!-- start item -->
                                    <div class="col-12 col-sm-6 col-md-4 col-lg-6 d-sm-flex">
        ...
        <section class="section">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="section-heading section-heading--center">
                            <h5 class="__subtitle">Partners</h5>

                            <h2 class="__title">People Who Trust Us</h2>
                        </div>
        ...
        <section class="section section--bg-img jarallax" data-speed="0.3" data-img-position="50% 60%" style="background-image: url(img/bg_4.jpg);background-color: #f95a3f;">
            <div class="container">
                <div class="row align-items-lg-end">
                    <div class="col-12 col-md-10 col-lg-3 offset-md-1">

                        <div class="section-heading section-heading--white section-heading--left">
                            <h2 class="__title">Newsletters</h2>
                        </div>

                        <div class="spacer py-6 d-lg-none"></div>

                    </div>

                    <div class="col-12 col-md-10 col-lg-7 offset-md-1 offset-lg-0">

                        <form class="form-subscribe form--horizontal" action="#">
