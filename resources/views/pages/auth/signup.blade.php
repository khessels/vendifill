                                            ...
                                            <div class="row no-gutters justify-content-sm-center justify-content-md-start">
                                                ...
                                                @c(['key' => 'service_1', 'page' => $page, 'editable'=> true, 'default' => '
                                                    <div class="col-12 col-sm-9 col-md-6 col-lg-3 d-sm-flex">
                                                        <div class="__item">
                                                            <div class="__header">
                                                                <div class="__title h4">You have\want Vending machines</div>
                                                                <div class="__price">Vendor</div>
                                                            </div>
                                                            <div class="__body  pt-8 pb-9">
                                                                <ul class="__desc-list">
                                                                    <li><i class="fontello-ok"></i>Vending machines</li>
                                                                    <li><i class="fontello-ok"></i>Contactless payments</li>
                                                                    <li><i class="fontello-ok"></i>Bookkeeping tools</li>
                                                                    <li><i class="fontello-ok"></i>Product refill services</li>
                                                                    <li><i class="fontello-ok"></i>Machine cleaning services</li>
                                                                </ul>
                                                            </div>
                                                            <div class="__footer">
                                                                <a class="custom-btn custom-btn--medium custom-btn--s1" href="#">Register</a>
                                                            </div>
                                                        </div>
                                                    </div>'])
                                                <!-- end item -->
                                                ...
                                                @c(['key' => 'service_2', 'page' => $page, 'editable'=> true, 'default' => '
                                                    <div class="col-12 col-sm-9 col-md-6 col-lg-3 d-sm-flex">
                                                        <div class="__item">
                                                            <div class="__header">
                                                                <div class="__title h4">Our machines need filling</div>
                                                                <div class="__price">Driver</div>
                                                            </div>
                                                            <div class="__body  pt-8 pb-9">
                                                                <ul class="__desc-list">
                                                                    <li><i class="fontello-ok"></i>We use drivers to fill our machines</li>
                                                                    <li><i class="fontello-ok"></i>Earn money in the low hours</li>
...
{{--                                                                    <li><i class="fontello-ok"></i>Lowest transaction fees in Costa Rica</li>--}}
                                                ...
                                                @c(['key' => 'service_3', 'page' => $page, 'editable'=> true, 'default' => '
                                                    <div class="col-12 col-sm-9 col-md-6 col-lg-3 d-sm-flex">
                                                        <div class="__item">
                                                            <div class="__header">
                                                                <div class="__title h4">Outlet manager</div>

                                                                <div class="__price">Outlet</div>
                                                            </div>

                                                            <div class="__body  pt-8 pb-9">
                                                                <ul class="__desc-list">
                                                                    <li><i class="fontello-ok"></i>Receive and handle orders in the morning for preparation</li>
                                                                    <li><i class="fontello-ok"></i>Boost your business with Additional sales</li>
{{--                                                                    <li><i class="fontello-ok"></i>Spikefish brown trout </li>--}}
{{--                                                                    <li><i class="fontello-ok"></i>Loach summer flounder </li>--}}
                                                                </ul>
                                                            </div>
                                                ...
                                                @c(['key' => 'service_4', 'page' => $page, 'editable'=> true, 'default' => '
                                                    <div class="col-12 col-sm-9 col-md-6 col-lg-3 d-sm-flex">
                                                        <div class="__item">
                                                            <div class="__header">
                                                                <div class="__title h4">Collect bonuses for providing locations</div>
                                                            ...
                                                            <div class="__body  pt-8 pb-9">
                                                                <ul class="__desc-list">
                                                                    <li><i class="fontello-ok"></i>Send a location with photos and details</li>
                                                                    <li><i class="fontello-ok"></i>Each successful location earns you a minimum of 50$</li>
                                                                </ul>
                                                            </div>
