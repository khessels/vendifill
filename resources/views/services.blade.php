						...
						<div class="row">
							<div class="col-12 col-lg-4">
								<div class="section-heading">
									<h5 class="__subtitle">Main Services</h5>

									<h2 class="__title">VendiFill Machines <span>Services</span></h2>
								</div>
										...
										<div class="row">
											...
											<div class="col-12 col-sm-6 col-md-4 col-lg-3">
												<div class="__item">
													...
													<h4 class="__title"><a href="javascript:void(0)">Guarntee 100%</a></h4>
											...
											<div class="col-12 col-sm-6 col-md-4 col-lg-3">
												<div class="__item">
													...
													<h4 class="__title"><a href="javascript:void(0)">Machine Installation</a></h4>

													<p>Flagfin Atlantic saury, stonecat beachsalmon, silver dollar South American Lungfish. Reef triggerfish</p>
												</div>
											</div>
											<!-- end item -->
											...
											<div class="col-12 col-sm-6 col-md-4 col-lg-3">
												<div class="__item">
													...
													<h4 class="__title"><a href="javascript:void(0)">Eco Vending</a></h4>

													<p>South American Lungfish. Reef triggerfish dogteeth. Flagfin Atlantic saury, stonecat beachsalmon, silver</p>
												</div>
											</div>
											<!-- end item -->
											...
											<div class="col-12 col-sm-6 col-md-4 col-lg-3">
												<div class="__item">
													...
													<h4 class="__title"><a href="javascript:void(0)">Support 24/7</a></h4>

													<p>Reef triggerfish dogteeth. Flagfin Atlantic saury, stonecat beachsalmon, silver dollar South American </p>
												</div>
											</div>
											<!-- end item -->
											...
											<div class="col-12 col-sm-6 col-md-4 col-lg-3">
												<div class="__item">
													...
													<h4 class="__title"><a href="javascript:void(0)">Quick Delivery</a></h4>

													<p>Stonecat beachsalmon, silver dollar South American Lungfish. Reef triggerfish dogteeth. Flagfin Atlantic </p>
												</div>
											</div>
											<!-- end item -->
										</div>
							...
							<div class="col-12">
								...
								<div class="video-block">
									<div class="__bg lazy" data-bg="url('img/video_bg.jpg')" style="background-color: #eee;background-position: 20% 50%;">
										<a href="https://www.youtube.com/embed/1zG1iq9LZ2U" class="btn_play btn_play--dark" data-fancybox="video" style="max-width: 60%;">
											<span class="d-table">
												<span class="d-table-cell align-middle"><i></i></span>
												<span class="d-table-cell align-middle">Watch Video Presentation</span>
											</span>
										</a>
									</div>
								</div>
						...
						<div class="row align-items-lg-center">
							...
							<div class="col-12 col-lg-6">
								<div class="content-container">
									...
									<h2>Awesome Services by VendiFill</h2>
