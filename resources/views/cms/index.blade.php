...
{{--    @include('partials.error-alert')--}}
    <div class="grid auto-rows-min gap-4 md:grid-cols-3">
        ...
        <div class="relative aspect-video overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700">
            ...
            <form style="margin-left:200px;" action="/cms/database" method="post">
                @csrf
    ...
    <div style="margin-top:100px;" class="relative h-full flex-1 overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700">
        <div>
